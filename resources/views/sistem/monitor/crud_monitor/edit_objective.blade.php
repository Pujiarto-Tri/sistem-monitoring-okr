...
<body>
   ...
   <!--
    ...
    <div class="row">
        <div class="col-sm">
            <form method="POST" action="/sistem/monitor/{{ $objective -> objective_id }}/{{ $keyresult -> keyresult_id }}">
                @method('patch')
                @csrf   
                <script>
                    function add()
                ...
                <div class="form-group">
                    <label for="newObjective" class="form-label">Objective</label>
                        <input type="text" id=newObjective name="objective_name" class="form-control" value="{{ $objective -> objective_name}}"{{-- "@error ('objective_name') is-invalid @enderror" --}}></input>
                            {{-- @error
                ...
                <div class="form-group">
                    <label for="newKeyresult" class="form-label">Keyresult</label>
                        <input type="text" id=newKeyresult name="keyresult_name" class="form-control" value="{{ $keyresult -> keyresult_name}}"></input>
                </div>
                <div class="form-group">
